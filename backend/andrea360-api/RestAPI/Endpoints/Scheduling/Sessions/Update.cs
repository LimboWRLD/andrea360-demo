...
{
    public sealed record UpdateRequest(Guid SessionId, DateTime StartTime, DateTime EndTime, Guid LocationId, Guid ServiceId, int MaxCapacity, int CurrentCapacity);
    ...
    public class Update : Endpoint<UpdateRequest, GetLocationResponse>
    {
        ...
        {
            var command = new UpdateSessionCommand(req.SessionId, req.StartTime, req.EndTime, req.LocationId, req.ServiceId, req.MaxCapacity, req.CurrentCapacity);
